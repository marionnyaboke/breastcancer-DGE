...
directory <- "C:/Users/Marion/Desktop/DGE/AA/all-counts/Luminal B/"
dir(directory)
...
write.csv(sigDownReg, file="C:/Users/Marion/Desktop/DGE/AA/all-counts/Luminal B/sigDownReg-filtered.csv")
write.csv(sigUpReg, file="C:/Users/Marion/Desktop/DGE/AA/all-counts/Luminal B/sigUpReg-filtered.csv")
...
volc = ggplot(input, aes(logFC, -log10(PValue))) + #volcanoplot with logFC versus pvalue
  geom_point() +
  theme_classic()+
  geom_vline(xintercept=c(-1.5, 1.5), col="orange", linetype="dashed") +
