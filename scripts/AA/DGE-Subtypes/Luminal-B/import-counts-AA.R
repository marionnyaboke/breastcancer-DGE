...
# # where are we?
cntdir <- here::here("C:/Users/Marion/Desktop/DGE/AA/all-counts/Luminal B")
pat <- "_gene_counts.txt"
...
for (i in 1:length(myfiles) ) {
  ...
  cnts <- gsub("(.*)_gene_counts.txt", "\\1", myfiles[i])
...
#          file = here::here("C:/Users/Marion/Desktop/DGE/AA/reads_count_summary.csv"),
#          row.names = TRUE)
...
# write data to files
saveRDS(reads_count, file = here::here("C:/Users/Marion/Desktop/DGE/AA/all-counts/Luminal B/reads_count.RDS"))


# reads_count <- rownames_to_column(reads_count,"transcript_id")
write.csv(reads_count, 
          file = here::here("C:/Users/Marion/Desktop/DGE/AA/all-counts/Luminal B/reads_count.csv"))
