...
directory <- "C:/Users/Marion/Desktop/DGE/AA/all-counts/Luminal A/"
dir(directory)

# read files
rawCountTable <- read.csv(paste0(directory,"reads_count.csv"), header=TRUE,
                            row.names=1)
sampleInfo <- read.csv(paste0(directory,"metadata-LumA.csv"), header=TRUE,
                         row.names=1)
...
condition = c("Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor", 
              ...
              "Solid Tissue Normal", "Solid Tissue Normal", "Primary Tumor", 
...
write.csv(sigDownReg, file="C:/Users/Marion/Desktop/DGE/AA/all-counts/Luminal A/sigDownReg-filtered.csv")
write.csv(sigUpReg, file="C:/Users/Marion/Desktop/DGE/AA/all-counts/Luminal A/sigUpReg-filtered.csv")
