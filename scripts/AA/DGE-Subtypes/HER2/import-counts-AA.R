...
# # where are we?
cntdir <- here::here("C:/Users/Marion/Desktop/DGE/AA/all-counts/HER2")
...
# write data to files
saveRDS(reads_count, file = here::here("C:/Users/Marion/Desktop/DGE/AA/reads_count.RDS"))


# reads_count <- rownames_to_column(reads_count,"transcript_id")
write.csv(reads_count, 
          file = here::here("C:/Users/Marion/Desktop/DGE/AA/all-counts/HER2/reads_count.csv"))
