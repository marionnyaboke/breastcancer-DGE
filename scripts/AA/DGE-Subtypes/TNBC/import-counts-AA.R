...
# # where are we?
cntdir <- here::here("C:/Users/Marion/Desktop/DGE/AA/all-counts/TNBC")
...
# write data to files
saveRDS(reads_count, file = here::here("C:/Users/Marion/Desktop/DGE/AA/all-counts/TNBC/reads_count.RDS"))


# reads_count <- rownames_to_column(reads_count,"transcript_id")
write.csv(reads_count, 
          file = here::here("C:/Users/Marion/Desktop/DGE/AA/all-counts/TNBC/reads_count.csv"))
