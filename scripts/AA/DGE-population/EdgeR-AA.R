...
rawCountTable <- read.csv(paste0(directory,"reads_count.csv"), header=TRUE,
                            row.names=1)
sampleInfo <- read.csv(paste0(directory,"Metadata-final.csv"), header=TRUE,
                         row.names=1)
...
condition = c("Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor",
              "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor",
              "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor",
              "Solid Tissue Normal", "Primary Tumor", "Solid Tissue Normal", "Solid Tissue Normal", "Primary Tumor",
              "Primary Tumor", "Solid Tissue Normal", "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor", 
              "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor", 
              "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor", 
              "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor")
...
hist(pseudoCounts[,"TCGA.OL.A6VR.01A"])
...
write.csv(sigDownReg, file="sigDownReg-filtered.csv")
write.csv(sigUpReg, file="sigUpReg-filtered.csv")
...
volc = ggplot(input, aes(logFC, -log10(PValue))) + #volcanoplot with logFC versus pvalue
  ...
  geom_hline(yintercept=-log10(0.0025), col="orange" , linetype="dashed")+
