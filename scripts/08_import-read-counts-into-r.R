...
# # where are we?
cntdir <- here::here("C:/Users/user/Desktop/marion/RNAseq/Counts")
pat <- ".counts.txt"
...
write.csv(reads_count_summary,
          file = here::here("C:/Users/user/Desktop/marion/RNAseq/reads_count_summary.csv"),
          row.names = TRUE)
...
write.csv(reads_count, 
          file = here::here("C:/Users/user/Desktop/marion/RNAseq/reads_count.csv"))
