...
condition = c("Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor", 
              ...
              "Primary Tumor", "Primary Tumor", "Primary Tumor", "Primary Tumor",
              "Solid Tissue Normal", "Solid Tissue Normal", "Solid Tissue Normal",
              "Solid Tissue Normal", "Primary Tumor", "Solid Tissue Normal", "Solid Tissue Normal",
...
dge$samples$group <- relevel(dge$samples$group, ref="Solid Tissue Normal") #sets Solid Tissue Normal as the control group
...
# if logFC > 1 and FDR < 0.05, set as "UP"
...
volc <- volc+geom_text_repel(data=head(input, 500), aes(label=gene), size = 3) #adding text for the top genes
volc
