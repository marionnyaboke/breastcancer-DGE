...
# # where are we?
cntdir <- here::here("C:/Users/user/Desktop/marion/Analysis/CA/all-counts")
pat <- "_counts.txt"
...
# write data to files
saveRDS(reads_count, file = here::here("C:/Users/user/Desktop/marion/Analysis/CA/reads_count.RDS"))


# reads_count <- rownames_to_column(reads_count,"transcript_id")
write.csv(reads_count, 
          file = here::here("C:/Users/user/Desktop/marion/Analysis/CA/reads_count.csv"))
