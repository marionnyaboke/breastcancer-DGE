...
directory <- "C:/Users/Marion/Desktop/DGE/CA/all-counts/HER2/"
dir(directory)
...
condition = c("Primary Tumor", "Primary Tumor", "Primary Tumor", 
              ...
              "Solid Tissue Normal", "Solid Tissue Normal", "Solid Tissue Normal", "Primary Tumor", 
              "Primary Tumor", "Solid Tissue Normal", "Primary Tumor", "Primary Tumor", 
              "Primary Tumor")
...
write.csv(sigDownReg, file="C:/Users/Marion/Desktop/DGE/CA/all-counts/HER2/sigDownReg-filtered.csv")
write.csv(sigUpReg, file="C:/Users/Marion/Desktop/DGE/CA/all-counts/HER2/sigUpReg-filtered.csv")
