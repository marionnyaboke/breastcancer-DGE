...
# # where are we?
cntdir <- here::here("C:/Users/Marion/Desktop/DGE/CA/all-counts/Luminal A/")
pat <- "_counts.txt"
...
#          file = here::here("C:/Users/user/Desktop/marion/Analysis/CA/reads_count_summary.csv"),
#          row.names = TRUE)
...
# write data to files
saveRDS(reads_count, file = here::here("C:/Users/Marion/Desktop/DGE/CA/all-counts/Luminal A/reads_count.RDS"))


# reads_count <- rownames_to_column(reads_count,"transcript_id")
write.csv(reads_count, 
          file = here::here("C:/Users/Marion/Desktop/DGE/CA/all-counts/Luminal A/reads_count.csv"))
