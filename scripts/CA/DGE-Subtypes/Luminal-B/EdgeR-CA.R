...
directory <- "C:/Users/Marion/Desktop/DGE/CA/all-counts/Luminal B/"
dir(directory)
...
condition = c("Primary Tumor", "Solid Tissue Normal", "Solid Tissue Normal",   
...
write.csv(sigDownReg, file="C:/Users/Marion/Desktop/DGE/CA/all-counts/Luminal B/sigDownReg-filtered.csv")
write.csv(sigUpReg, file="C:/Users/Marion/Desktop/DGE/CA/all-counts/Luminal B/sigUpReg-filtered.csv")
