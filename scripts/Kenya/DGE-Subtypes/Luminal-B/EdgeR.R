...
directory <- "C:/Users/Marion/Desktop/DGE/DGE-Kenya/Counts/Luminal B/"
dir(directory)

# read files
rawCountTable <- read.csv(paste0(directory,"reads_count.csv"), header=TRUE,
                            row.names=1)
sampleInfo <- read.csv(paste0(directory,"metadata-LumB.csv"), header=TRUE,
                         row.names=1)
...
condition = c("Normal", "Normal", "Normal", "Tumor", "Normal", "Tumor", "Normal", "Tumor", 
              "Normal", "Normal", "Normal", "Normal", "Normal", "Normal", "Tumor")
...
dge$samples$group <- relevel(dge$samples$group, ref="Normal") #sets non-african as the control group
...
write.csv(sigDownReg, file="C:/Users/Marion/Desktop/DGE/DGE-Kenya/Counts/Luminal B/sigDownReg-filtered.csv")
write.csv(sigUpReg, file="C:/Users/Marion/Desktop/DGE/DGE-Kenya/Counts/Luminal B/sigUpReg-filtered.csv")
