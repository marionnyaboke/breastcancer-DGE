...
# # where are we?
cntdir <- here::here("C:/Users/Marion/Desktop/DGE/DGE-Kenya/Counts/HER2/")
pat <- "counts.txt"
...
write.csv(reads_count_summary,
          file = here::here("C:/Users/Marion/Desktop/DGE/DGE-Kenya/Counts/HER2/reads_count_summary.csv"),
          row.names = TRUE)
...
# write data to files
saveRDS(reads_count, file = here::here("C:/Users/Marion/Desktop/DGE/DGE-Kenya/Counts/HER2/reads_count.RDS"))


# reads_count <- rownames_to_column(reads_count,"transcript_id")
write.csv(reads_count, 
          file = here::here("C:/Users/Marion/Desktop/DGE/DGE-Kenya/Counts/HER2/reads_count.csv"))
