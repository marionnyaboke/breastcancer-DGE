...
directory <- "C:/Users/Marion/Desktop/DGE/DGE-Kenya/Counts/HER2/"
dir(directory)
...
condition = c("Tumor", "Normal", "Normal", "Normal", "Normal", "Normal", "Normal", 
              "Normal", "Normal", "Normal", "Normal", "Normal", "Tumor", "Normal", "Tumor")
