...
directory <- "C:/Users/Marion/Desktop/DGE/DGE-Kenya/Counts/Luminal A/"
dir(directory)
...
condition = c("Normal", "Normal", "Tumor", "Normal", "Normal", "Normal", "Normal", 
...
write.csv(sigDownReg, file="C:/Users/Marion/Desktop/DGE/DGE-Kenya/Counts/Luminal A/sigDownReg-filtered.csv")
write.csv(sigUpReg, file="C:/Users/Marion/Desktop/DGE/DGE-Kenya/Counts/Luminal A/sigUpReg-filtered.csv")
